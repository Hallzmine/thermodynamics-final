...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth,trim=0pt 0pt 0pt 0pt,clip]{media/parametric.png}
  \caption{Work done by the turbine as affected by a variable pressure exiting the boiler.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth,trim=0pt 0pt 0pt 0pt,clip]{media/efftherm.png}
  \caption{Thermal efficiency as affected by a variable pressure leaving the boiler}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth,trim=0pt 0pt 0pt 0pt,clip]{media/cond.png}
  \caption{Work done by the turbine as affected by a variable pressure leaving the condenser}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth,trim=0pt 0pt 0pt 0pt,clip]{media/contherm.png}
  \caption{Thermal efficiency as affected by a variable pressure leaving the condenser}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth,trim=0pt 0pt 0pt 0pt,clip]{media/temwork.png}
  \caption{Work done by turbine as affected by a variable temperature leaving the boiler}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth,trim=0pt 0pt 0pt 0pt,clip]{media/temtherm.png}
